...
const ADMIN_AUTO_INVOICE_RUNS = [
  { id: 'run-0007', periodFrom: isoDaysAgo(7), periodTo: isoDaysAgo(0), triggeredBy: 'scheduled', status: 'completed', clientsBilled: 4, clientsSkipped: 2, clientsFailed: 0, invoicesCreated: 4, totalAmount: '0', currency: 'GBP', startedAt: isoDaysAgo(0), finishedAt: isoDaysAgo(0), error: null },
  { id: 'run-0006', periodFrom: isoDaysAgo(14), periodTo: isoDaysAgo(7), triggeredBy: 'scheduled', status: 'completed', clientsBilled: 5, clientsSkipped: 1, clientsFailed: 0, invoicesCreated: 5, totalAmount: '0', currency: 'GBP', startedAt: isoDaysAgo(7), finishedAt: isoDaysAgo(7), error: null },
  { id: 'run-0005', periodFrom: isoDaysAgo(21), periodTo: isoDaysAgo(14), triggeredBy: 'manual', status: 'completed', clientsBilled: 3, clientsSkipped: 3, clientsFailed: 1, invoicesCreated: 3, totalAmount: '0', currency: 'GBP', startedAt: isoDaysAgo(14), finishedAt: isoDaysAgo(14), error: null },
  { id: 'run-0004', periodFrom: isoDaysAgo(28), periodTo: isoDaysAgo(21), triggeredBy: 'scheduled', status: 'failed', clientsBilled: 0, clientsSkipped: 0, clientsFailed: 0, invoicesCreated: 0, totalAmount: '0', currency: 'GBP', startedAt: isoDaysAgo(21), finishedAt: isoDaysAgo(21), error: 'Xero rate-limited (HTTP 429) — run aborted, retried next cycle.' },
  { id: 'run-0003', periodFrom: isoDaysAgo(35), periodTo: isoDaysAgo(28), triggeredBy: 'scheduled', status: 'completed', clientsBilled: 4, clientsSkipped: 2, clientsFailed: 0, invoicesCreated: 4, totalAmount: '0', currency: 'GBP', startedAt: isoDaysAgo(28), finishedAt: isoDaysAgo(28), error: null },
];
...
const ADMIN_WORKFLOWS = [
  ...
  { id: 'wf-2', name: 'Weekly auto-invoicing', description: 'Pulls client invoices from Xero for clients with deliveries that week.', type: 'finance', schedule: '0 6 * * 1', status: 'active', handlerKey: 'auto-invoice', lastRunAt: isoDaysAgo(0), nextRunAt: isoDaysAgo(-7), totalRuns: 52, successRate: 96.2 },
